...
<div class="title_list">
  ...
  <div class="title_key">
    <dl>
      <?php $_from = $this->_var['goods_cat']['cat_clild']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_59959400_1438923593');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_59959400_1438923593']):
        $this->_foreach['foo']['iteration']++;
?>
      <dd><a href="<?php echo $this->_var['cat_0_59959400_1438923593']['url']; ?>" target="_blank" title="<?php echo $this->_var['cat_0_59959400_1438923593']['name']; ?>"><?php echo $this->_var['cat_0_59959400_1438923593']['name']; ?></a></dd>
...
?> 
  ...
  <div class="brand_right" >
    <div class="brand_list_out"> 
      <?php $_from = $this->_var['cat_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');$this->_foreach['nocat'] = array('total' => count($_from), 'iteration' => 0);
...
?> 
      ...
      <div class="brand_list">
        <div class="brand_img"> <a href="<?php echo $this->_var['goods']['url']; ?>"><img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" width="170" height="170" /></a></div>
        <div class="brand_txt"> <b><a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo htmlspecialchars($this->_var['goods']['short_name']); ?></a></b>
          <p> 
            ...
            <?php endif; ?> 
            <font class="marker_s"><?php echo $this->_var['goods']['market_price']; ?></font> </p>
        </div >
      </div>
      <?php endif; ?> 
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 

...
E_D("replace into `ecs_touch_action` values('169','1','comment_manage','');");
E_D("replace into `ecs_touch_action` values('174','0','db_manage','');");
E_D("replace into `ecs_touch_action` values('175','170','db_backup','');");
E_D("replace into `ecs_touch_action` values('176','170','db_optimize','');");
E_D("replace into `ecs_touch_action` values('177','170','sql_query','');");

...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','夜义乌','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','夜义乌','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','夜义乌','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','夜义乌','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','夜义乌','1');");

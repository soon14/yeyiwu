...
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/cat_articles.lbi','1','4','5','3','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','','/library/recommend_best.lbi','0','0','6','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','','/library/group_buy.lbi','0','0','2','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','','/library/recommend_promotion.lbi','0','0','4','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','中部主区域','/library/recommend_hot.lbi','2','0','4','0','miqinew','');");
E_D("replace into `ecs_touch_template` values('index','','/library/recommend_new.lbi','0','0','8','0','miqinew','');");

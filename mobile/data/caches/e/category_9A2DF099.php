<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:52:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/category.dwt";i:1;s:69:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/library/goods_list_search.lbi";i:2;s:57:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/library/pages.lbi";i:3;s:63:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1440424008;s:8:"maketime";i:1440420408;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>空间派对_酒吧_夜义乌 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=164&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合</a> </li>
      <li class=""> <a href="category.php?category=164&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=164&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=164&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <input type="hidden" name="order" value="" />
        ...
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="goods.php?id=172&u=4937" > <img src="http://www.jialun168.net/images/201508/thumb_img/172_thumb_G_1438888077785.jpg" alt="空间派对酒吧 青岛啤酒150元/箱"> </a> </div>
          <div class="proInfo-wrap">
            <div class="proTitle"> <a href="goods.php?id=172&u=4937" >空间派对酒吧 青岛啤酒150元/箱</a> </div>
        ...
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="category.php?id=164&page=1">1</option>
                                    </select>
          </div>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=164&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=&order=', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})

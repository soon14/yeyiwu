<?php exit;?>a:3:{s:8:"template";a:4:{i:0;s:52:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/category.dwt";i:1;s:69:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/library/goods_list_search.lbi";i:2;s:57:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/library/pages.lbi";i:3;s:63:"D:/yeyiwu/wwwroot/mobile/themes/miqinew/library/page_footer.lbi";}s:7:"expires";i:1440426705;s:8:"maketime";i:1440423105;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>名仕酒吧_酒吧_夜义乌 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class=""> <a href="category.php?category=163&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC&keywords=#goods_list&">综合</a> </li>
      <li class=""> <a href="category.php?category=163&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC&keywords=#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class=""> <a href="category.php?category=163&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_count&order=DESC&keywords=#goods_list">销量</a></li>
      <li class=""> <a href="category.php?category=163&display=&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC&keywords=#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <input type="hidden" name="order" value="" />
        ...
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="goods.php?id=197&u=4939" > <img src="http://www.jialun168.net/images/201508/thumb_img/197_thumb_G_1438920112034.jpg" alt="名仕酒吧 鹰勇威士忌280元/套"> </a> </div>
          <div class="proInfo-wrap">
            <div class="proTitle"> <a href="goods.php?id=197&u=4939" >名仕酒吧 鹰勇威士忌280元/套</a> </div>
            ...
            <div class="proService"> <del>￥<span>336</span></del></div>
            ...
            <div id="more_element_1" class="product flex_in single_item">
        <div class="pro-inner">
          <div class="proImg-wrap"> <a href="goods.php?id=171&u=4939" > <img src="http://www.jialun168.net/images/201508/thumb_img/171_thumb_G_1438907792429.jpg" alt="名仕酒吧 哈尔滨啤酒280元/箱"> </a> </div>
          <div class="proInfo-wrap">
            <div class="proTitle"> <a href="goods.php?id=171&u=4939" >名仕酒吧 哈尔滨啤酒280元/箱</a> </div>
            <div class="proSKU"></div>
            <div class="proPrice"> 
            ...
            <div class="proService"> <del>￥<span>0</span></del></div>
            <div class="proSales">月销:<em>0</em></div>
            <div class="proIcons"> 
        ...
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="pagenav-cur">
            ...
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="category.php?id=163&page=1">1</option>
                                    </select>
          </div>
  ...
  <p class="link region"> <a href="http://www.jialun168.net/?computer=1"> 电脑版 </a> <a href="./"> 触屏版 </a> <a href="#"> 苹果客户端 </a> <a class="#"> Android客户端 </a> </p>
  <p class="region"> 
     
    &copy; 2005-2015 夜义乌 版权所有，并保留所有权利。 </p>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=163&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=&order=', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/miqinew/images/loader.gif" /></div>'})

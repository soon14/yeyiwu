...
?>
      ...
      <section class="order_box padd1 radius10" style="padding-top:0;padding-bottom:0;">
          <div class="table_box table_box2">
		   <dl>
              <dd class="dd1">可提现余额</dd>
			  <dd>
			  <?php echo $this->_var['sur_amount']; ?>
			</dd>			
            </dl>
			<dl >
              <dd class="dd1">提现额度</dd>
			  <dd>
			 <?php echo $this->_var['limit_account_replay']; ?>
			</dd>			
            </dl>
            <dl>
            ...
            <dl>
              ...
              <input name="real_name" type="text" placeholder="输入真实姓名如：如:夜义乌"  class="dd2">
            </dl>
             <dl>
              <dd class="dd1">开户行 </dd>
      ...
      <?php if ($this->_var['action'] == "account_raply_psw"): ?>
		<style type="text/css">
		...
		<header id="header">
		 ...
		 <div class="cart_tips">
		     <ul>
				<li>提示：您还未设置提现密码，请在下面的输入框中设置密码</li>
		      </ul>
		 </div>
		<section class="wrap">
		        <section class="order_box padd1 radius10">  
		   ...
		   <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
		          ...
		          <td align="left"><input name="password_account_replay1" type="password" size="25"  class="inputBg" value=""/></td>
		        </tr>
		        <tr>
		          <td align="right">确认密码：</td>
		          <td align="left"><input name="password_account_replay2" type="password" size="25"  class="inputBg" value=""/></td>
		        </tr>
		        <tr>
		        	<td colspan="2" align="center">
		        	<input name="act" type="hidden" value="account_raply" />
		       		<input name="bind" type="submit" value="保存" class="c-btn3 radius5" style="border:none; margin-right:10px; width:30%;" />
		 			</td>
		 		</tr>
		    </table>    
		    </form>
      ...
      <?php if ($this->_var['action'] == "account_raply_checkpsw"): ?>
		<style type="text/css">
			 .dataForm .inputBg{width:200px;}
		</style>
		<header id="header">
		...
		<section class="wrap">
		   ...
		   <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
		          ...
		          <td align="left"><input name="password_account_replay" type="password" size="25"  class="inputBg" value=""/></td>
		        </tr>
		        <tr>
		        	<td colspan="2" align="center">
		        	<input name="act" type="hidden" value="account_raply" />
		       		<input name="bind2" type="submit" value="确定" class="c-btn3 radius5" style="border:none; margin-right:10px; width:30%;" />
		 			</td>
		 		</tr>
		    </table>    
		    </form>

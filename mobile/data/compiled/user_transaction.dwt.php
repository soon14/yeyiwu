...
<section class="wrap">
   ...
   <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        ...
        <?php if ($this->_var['action'] == "account_raply_setting"): ?>
             <style type="text/css">
	 .dataForm .inputBg{width:200px;}
	 </style>
<header id="header">
...
<section class="wrap">
   ...
   <table width="100%" border="0" cellpadding="5" cellspacing="0" class="ectouch_table">
        <tr>
          <td width="70" align="right">原密码：</td>
          <td align="left"><input name="password_account_replay1" type="password" size="25"  class="inputBg" value="" placeholder="不修改请留空"/></td>
        </tr>
        <tr>
          <td align="right">新密码：</td>
          <td align="left"><input name="password_account_replay2" type="password" size="25"  class="inputBg" value="" placeholder="不修改请留空"/></td>
        </tr>
        <tr>
          <td align="right">确认密码：</td>
          <td align="left"><input name="password_account_replay3" type="password" size="25"  class="inputBg" value="" placeholder="不修改请留空"/></td>
        </tr>
        <tr>
          <td width="70" align="right">提现额度：</td>
          <td align="left"><input name="limit_account_replay" type="text" size="25"  class="inputBg" value="<?php echo $this->_var['limit_account_replay']; ?>" /></td>
        </tr>
        <tr><td colspan="2" align="center">
        <input name="act" type="hidden" value="account_raply_setting" />

...
<!--    <li class="crow level1">
      <div class="crow_row">
        <div class="crow_icon"> 
        	<img src="<?php echo $this->_var['cat']['ico']; ?>" /> 
        	<?php if ($this->_var['cat']['cat_id']): ?> <h1><?php echo htmlspecialchars($this->_var['cat']['name']); ?></h1> <?php else: ?> <h1><a href="<?php echo $this->_var['cat']['url']; ?>"><?php echo htmlspecialchars($this->_var['cat']['name']); ?></a></h1> <?php endif; ?>
        </div>
...
?>
	<li class="crow"> 
        <!--<div class="crow_icon"> <img src="<?php echo $this->_var['child']['ico']; ?>" /> </div>-->

        <div class="crow_item   <?php if (($this->_foreach['no1']['iteration'] - 1) % 1 == 0): ?>  crow_item_clear <?php endif; ?> "> 
        	<img src="<?php echo $this->_var['child']['ico']; ?>" />
        	<a href="<?php echo $this->_var['child']['url']; ?>"><?php echo htmlspecialchars($this->_var['child']['name']); ?></a> </div>
    </li>

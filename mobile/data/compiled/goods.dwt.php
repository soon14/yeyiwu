...
<!--甜心修改兼容收藏
  ...
  <div class="title">
    <h1> <?php echo $this->_var['goods']['goods_style_name']; ?> 
    
    </h1>
  </div>
    <div class="title">
    <?php echo $this->_var['goods']['goods_brief']; ?> 
    <div style=" float:right"><a href="tel:15394385444" >联系客服:
      <img src="themes/miqinew/images/2.png" style="width:50px;height:50px; vertical-align:middle;" /></a>
    </div>
  </div>
  <ul>
    <?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?>
    <li><?php echo $this->_var['lang']['promote_price']; ?><b class="price"><?php echo $this->_var['goods']['shop_price_formated']; ?></b>　<?php if ($this->_var['cfg']['show_marketprice']): ?>

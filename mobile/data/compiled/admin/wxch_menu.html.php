...
<!-- 通用信息 -->
<table width="70%" id="one-table" align="center">
    <tr>
...
<table width="70%" id="two-table" align="center" style="display:none">
    <tr>
            <td class="label">级别&nbsp;&nbsp;</td>
            <td><strong>类型</strong></td>
            <td><strong>名称</strong></td>
...
<table width="70%" id="three-table" align="center" style="display:none">
    <tr>
            <td class="label">级别&nbsp;&nbsp;</td>
            <td><strong>类型</strong></td>
            <td><strong>名称</strong></td>

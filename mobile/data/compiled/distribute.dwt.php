...
?>
	...
	-->
      <li><span class="uninclude">&nbsp; &nbsp; </span><span>我的佣金</span> <span class="person"><?php if ($this->_var['tianxin100all']['setmoney']): ?><?php echo $this->_var['tianxin100all']['setmoney']; ?><?php else: ?>0<?php endif; ?></span>
        <div class="son_list">
          <ul>
	   ...
	   <li><span class="uninclude">&nbsp; &nbsp; </span><span>个人购买分成</span> <span class="person"><?php if ($this->_var['tianxinallPersonal']): ?><?php echo $this->_var['tianxinallPersonal']; ?><?php else: ?>0<?php endif; ?></span>
        <div class="son_list">
          <ul>
            <li><span class="icon2">&nbsp; &nbsp; </span><span>未付款订单佣金</span> <span class="sp">￥<?php if ($this->_var['tianxinarrPersonal']['weifukuan']['setmoneyPersonal']): ?><?php echo $this->_var['tianxinarrPersonal']['weifukuan']['setmoneyPersonal']; ?><?php else: ?>0<?php endif; ?></span></li>
            <li><span class="icon2">&nbsp; &nbsp; </span><span>已付款订单佣金</span> <span class="sp">￥<?php if ($this->_var['tianxinarrPersonal']['yifukuan']['setmoneyPersonal']): ?><?php echo $this->_var['tianxinarrPersonal']['yifukuan']['setmoneyPersonal']; ?><?php else: ?>0<?php endif; ?></span></li>
            <li><span class="icon2">&nbsp; &nbsp; </span><span>已收货订单佣金</span> <span class="sp">￥<?php if ($this->_var['tianxinarrPersonal']['yishouhuo']['setmoneyPersonal']): ?><?php echo $this->_var['tianxinarrPersonal']['yishouhuo']['setmoneyPersonal']; ?><?php else: ?>0<?php endif; ?></span></li>
			<!--<li><span class="icon2">&nbsp; &nbsp; </span><span>可提现余额</span> <span class="sp"><?php echo $this->_var['info']['surplus']; ?></span></li>-->
	  ...
	  <li onclick="location.href='distribute.php?act=userrank';"><span class="uninclude">&nbsp; &nbsp; </span><span>会员消费排行榜</span></li>
    </ul>
  </div>
  <div class="blank3"></div>
  <div class="blank3"></div>

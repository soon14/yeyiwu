...
?>
    <li class="crow level1">
      <div class="crow_row">
        <div class="crow_icon"> <img src="<?php echo $this->_var['cat']['ico']; ?>" /> 
...
?>
        <li class="crow"> 
        <div class="crow_item   <?php if (($this->_foreach['no1']['iteration'] - 1) % 3 == 0): ?>  crow_item_clear <?php endif; ?> "> 

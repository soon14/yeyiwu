...
<dl class="user_top">
  ...
  <div class="user_top_list">
    <ul>
      ...
      <li> <a href="distribute.php?act=account_detail"> <strong><?php echo $this->_var['sur_amount']; ?></strong> <img  src="<?php echo $this->_var['ectouch_themes']; ?>/images/ico_user_03.png"> <span>余额</span> </a> </li>
